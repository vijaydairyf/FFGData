CREATE TABLE [dbo].[grp_Animal_Records]
(
...
[EartagNo] [nvarchar] (80) COLLATE Latin1_General_CI_AS NOT NULL,
...
GO
ALTER TABLE [dbo].[grp_Animal_Records] ADD CONSTRAINT [PK_grp_Animal_Records] PRIMARY KEY CLUSTERED  ([ID]) ON [PRIMARY]
GO
