CREATE TABLE [dbo].[grp_AnimalRecordValues]
(
...
GO
ALTER TABLE [dbo].[grp_AnimalRecordValues] ADD CONSTRAINT [PK_grp_AnimalRecordValues] PRIMARY KEY CLUSTERED  ([AnlValID]) ON [PRIMARY]
GO
