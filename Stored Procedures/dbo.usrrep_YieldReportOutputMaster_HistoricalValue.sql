...
-- =============================================
CREATE PROCEDURE [dbo].[usrrep_YieldReportOutputMaster_HistoricalValue]
...
IF @site = 'FO'
begin
EXEC					[usrrep_YieldReportOutput_FO_HistoricalValue] @BeginDate, @EndDate, @_Lots, @FromBatch, @ToBatch
end

IF @site = 'FC BH 1'
begin
EXEC					[usrrep_YieldReportOutput_FC_HistoricalValue] @BeginDate, @EndDate, @_Lots, @FromBatch, @ToBatch
end

IF @site = 'FC BH 2'
begin
EXEC					[usrrep_YieldReportOutput_FC_BH2_HistoricalValue] @BeginDate, @EndDate, @_Lots, @FromBatch, @ToBatch
end

IF @site = 'FG'
begin
EXEC					[usrrep_YieldReportOutput_FG_HistoricalValue] @BeginDate, @EndDate, @_Lots, @FromBatch, @ToBatch
end

IF @site = 'FD'
begin
EXEC					[usrrep_YieldReportOutput_FD_HistoricalValue] @BeginDate, @EndDate, @_Lots, @FromBatch, @ToBatch
end

IF @site = 'FH'
begin
EXEC				[usrrep_YieldReportOutput_FH_HistoricalValue] @BeginDate, @EndDate, @_Lots, @FromBatch, @ToBatch
end
