...
-- =============================================
CREATE PROCEDURE [dbo].[1118_Populate_AnimalRecordValues_Stbl_FC]
...
--===========================================================================================================================================
    ...
    WHERE convert(nvarchar(12),d.[Date],102) between convert(nvarchar(12),getdate()-2,102) and convert(nvarchar(12),getdate(),102)
	 --SELECT * FROM #DES
--===========================================================================================================================================
	 SELECT a.Beef_AphisData_ANL_Id as AphisID,replace(a.AnimalTagNumber,' ','') as EartagNo
	 INTO #ANL
