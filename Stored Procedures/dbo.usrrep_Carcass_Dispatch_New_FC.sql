...
Create PROCEDURE [dbo].[usrrep_Carcass_Dispatch_New_FC] 
...
left join [FM_Innova].[dbo].proc_prunits r on i.inventory = r.prunit
inner join [FM_Innova].[dbo].proc_materials m on m.material = i.material

Where r.prunit in (19) and cast(i.prday as date) between @from and @to
...
Select t.[site],t.ItemNo,t.Production,t.[Weight],t.KillNo,t.OrderNo,t.Inventory,t.Product,t.ProductCode,t.qtr --,(select count(t2.KillNo) from #tmp t2 group by t2.killno)as qtr
 from #tmp t
 order by t.KillNo,t.Production
