...
CREATE PROCEDURE [dbo].[0000-NavDetails]
...
Into #ResEnt2
From [ffgsql01].[FFG-PRODUCTION].dbo.[FFG LIVE$Reservation Entry] r With (NOLOCK)
...
Left Join [ffgsql01].[FFG-PRODUCTION].dbo.[FFG LIVE$Reservation Entry] r  With (NoLock) On o.NavLotNo COLLATE DATABASE_DEFAULT = r.[Lot No_]
