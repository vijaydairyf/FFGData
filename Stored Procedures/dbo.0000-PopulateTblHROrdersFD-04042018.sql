...
--exec [0000-PopulateTblHROrdersFD] '121777','1','FD'

Create PROCEDURE [dbo].[0000-PopulateTblHROrdersFD-04042018]
...
And a.siteid='4' --And  a.InProductionStock is null
...
Where (i.[Open] IN (1)) AND (i.Positive IN (1)) And i.[Location Code]='FD'
