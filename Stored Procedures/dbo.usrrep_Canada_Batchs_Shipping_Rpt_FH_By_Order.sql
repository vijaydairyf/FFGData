...
-- =============================================
CREATE PROCEDURE [dbo].[usrrep_Canada_Batchs_Shipping_Rpt_FH_By_Order]
...
left join [FFGSQL03].[FH_innova].[dbo].proc_orders as po with (nolock) on po.[order] = pp.[order]
left join [FFGSQL03].[FH_innova].[dbo].base_companies as com with (nolock) on com.company = po.customer
where 
po.[name] = @ordername
