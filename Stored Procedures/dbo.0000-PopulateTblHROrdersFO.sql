...
-- Description:	Look at the HA system and transfer in [FO_Innova]
-- =============================================

--exec [0000-PopulateTblHROrdersFO] '119957','1'

CREATE PROCEDURE [dbo].[0000-PopulateTblHROrdersFO]
...
And a.siteid='2' --And  a.InProductionStock is null
...
Where (i.[Open] IN (1)) AND (i.Positive IN (1)) And i.[Location Code]='FO'
