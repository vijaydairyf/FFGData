...
--exec [0000-PopulateTblHROrdersFG] '119957','1'

CREATE PROCEDURE [dbo].[0000-PopulateTblHROrdersFG]
...
And a.siteid='5' --And  a.InProductionStock is null
...
Where (i.[Open] IN (1)) AND (i.Positive IN (1)) And i.[Location Code]='FGL'
