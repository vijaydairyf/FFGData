...
CREATE PROCEDURE [dbo].[usrrep_YieldReportOutput_FH]
...
left join [FH_innova].[dbo].[proc_rmareas] as rma with (nolock) on rma.rmarea = PP.rmarea -- added by kh 16/11/18 for Into BH stamp
