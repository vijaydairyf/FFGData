...
--exec [0000-PopulateTblHROrdersFC] '122523','1','1'

CREATE PROCEDURE [dbo].[0000-PopulateTblHROrdersFC]
...
And a.siteid='1' --And  a.InProductionStock is null
...
Where (i.[Open] IN (1)) AND (i.Positive IN (1)) And i.[Location Code]='FC'
