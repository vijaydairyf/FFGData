...
CREATE PROCEDURE [dbo].[usrrep_YieldReportOutput_FD]
...
left join [FD_Innova].[dbo].[proc_rmareas] as rma with (nolock) on rma.rmarea = PP.rmarea -- added by kh 16/11/18 for Into BH stamp
