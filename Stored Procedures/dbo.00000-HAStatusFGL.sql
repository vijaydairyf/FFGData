...
--exec [00000-HAStatusFGL] '128463','1','FGL'

CREATE PROCEDURE [dbo].[00000-HAStatusFGL]
...
AS
		...
		If @FFGSite='FGL'
			BEGIN
				Select 'FGL' As SSite, o.[order], o.[name] As FFGSO, m.[code],
				Count(k.sscc) As PackQty, o.orderstatus As OrderStatus
				Into #t
				...
				Group By o.[order], o.[name], m.[code],o.orderstatus
