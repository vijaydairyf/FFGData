...
-- =============================================
Create PROCEDURE [dbo].[usrrep_SalesOrderDetail_FI]
...
from	[FI_Innova].[dbo].proc_packs as pp
		...
		left join [FI_Innova].[dbo].base_companies as bc2 with (nolock) on bc2.company = pl.customer
		left join [FI_Innova].[dbo].proc_countries as pcount with (nolock) on pcount.country = pl.brcountry
